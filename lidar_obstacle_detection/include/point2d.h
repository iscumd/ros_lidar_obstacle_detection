...
namespace geometry
{
     ...
     *
     * The purpose of this function is to give the ability to compare points that
     * represent sensor readings
        * No two sensor readings will be the same in continuous space therefore this
     * thresholding function is necesary
        * to compare points that are equal....but not quite
     *
     * @param p1 first ponit to compare
     * @param p2 second point to compare
     * @param threshold p1 and p2 must be within this value for them to be considered
     * equal
     * @return true is difference between points is less than threshold. Otherwise, false
     */
    bool close_enough( const Point2D& p1, const Point2D& p2,
