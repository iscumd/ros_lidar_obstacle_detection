...
float* ranges; // list of distance 'r' from each measured point
...
int main(int argc, char** argv) {
    ...
    ros::Publisher obstaclesPublisher = n.advertise<obstacle_detection::obstacles>("obstacle_detection/obstacles", 5);

    n.param("obstacle_min_x_position", minObstacleXPosition, 0);
    n.param("scan_start_index", start_index, 0);
    n.param("scan_end_index", end_index, int((angle_max / angle_increment))); // TODO: MIGHT BLOW HARD
